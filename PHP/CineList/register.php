...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($username === '' || $email === '' || $password === '') {
        ...
        $error = 'Nom d\'utilisateur : 3 à 50 caractères.';
...
<head>
  ...
  <style>
    ...
    .auth-card{width:100%;max-width:420px;background:var(--bg2);border:1px solid var(--border);border-radius:14px;padding:2.5rem 2rem;box-shadow:0 8px 40px rgba(0,0,0,.6)}
    ...
    .success-box{background:rgba(82,201,122,.12);border:1px solid rgba(82,201,122,.35);color:#6fdc96;padding:.7rem 1rem;border-radius:7px;font-size:.85rem;margin-bottom:1.2rem}
...
<div class="auth-card">
  ...
  <?php endif; ?>
  <?php if ($success): ?>
    <div class="success-box">✓ <?= htmlspecialchars($success) ?> <a href="login.php" style="color:var(--accent)">→ Se connecter</a></div>
  <?php endif; ?>
