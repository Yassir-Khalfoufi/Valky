...
// À inclure en haut de chaque page protégée : require_once 'auth.php';
...
/**
 * Vérifie si l'utilisateur est connecté (session ou cookie).
...
function requireLogin(): array {
    ...
    // 3. Non authentifié → redirection
    header('Location: login.php');
    exit;
}

/**
 * Vérifie un token "remember me" en base.
 */
...
/**
 * Crée un token "remember me" et pose le cookie.
 */
function setRememberCookie(int $userId): void {
    ...
    // Poser le cookie (HttpOnly, SameSite=Lax)
    setcookie(
        REMEMBER_COOKIE,
        $rawToken,
        [
...
/**
 * Supprime le cookie et le token en base.
 */
...
/**
 * Connecte un utilisateur (crée la session + remember si demandé).
 */
